...
//        mSubscriberViewContainer.addView(mSubscriber.getView());
        ...
        if (idForTwitterCall != null) {
            new AsyncTask<Void, Void, Void>() {
                ...
                protected Void doInBackground(Void... unused) {
                    ...
                    String urlString = "https://www.competize.com/api/adidas";
    ...
    private void setTweetEnabled(boolean enabled) {
        mMenu.findItem(R.id.action_tweet)
                .setEnabled(enabled)
                .setVisible(enabled);
    }
    ...
    private void publishToTwitter() {
        if(mSession != null) {
            idForTwitterCall = mCurrentArchiveId;
            mWebServiceCoordinator.stopArchive(mCurrentArchiveId);
        }
    }
}